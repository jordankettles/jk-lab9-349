...
Vagrant.configure("2") do |config|
  ...
  config.vm.provider :aws do |aws, override|
    ...
    aws.keypair_name = "jk-cosc349-lab09"
    ...
    override.ssh.private_key_path = "C:\\Users\\Jordan\\Downloads\\jk-cosc349-lab09.pem"
    ...
    # square brackets.
    #
    aws.security_groups = ["sg-0e611e9d747446bd9"]
